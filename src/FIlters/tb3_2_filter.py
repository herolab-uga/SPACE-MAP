...
if __name__ == "__main__":
    rospy.init_node('tb3_2_filter')

    my_namespace = 'tb3_2'  # specific to this file
    other_namespaces = ['tb3_1', 'tb3_0', 'tb3_3', 'tb3_4']
    rtabmap_namespace = 'rtabmap_2'  # specific to this file
