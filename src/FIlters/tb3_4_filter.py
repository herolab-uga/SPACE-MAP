...
if __name__ == "__main__":
    rospy.init_node('tb3_4_filter')

    my_namespace = 'tb3_4'  # specific to this file
    other_namespaces = ['tb3_1', 'tb3_2', 'tb3_3', 'tb3_0']
    rtabmap_namespace = 'rtabmap_4'  # specific to this file
